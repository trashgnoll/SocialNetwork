...
namespace SocialNetwork.PLL.Views
{
    public class RegistrationView
    {
        ...
        public void Show()
        {
            ...
            userRegistrationData.FirstName = InputView.ReadLine();

            Console.Write("Ваша фамилия:");
            userRegistrationData.LastName = InputView.ReadLine();

            Console.Write("Пароль:");
            userRegistrationData.Password = InputView.ReadLine();

            Console.Write("Почтовый адрес:");
            userRegistrationData.Email = InputView.ReadLine();
